...
class Game
{
	...
	public:
		...
		//:::::Prints instructions if prompted, sets players::::://
		void setup()
		{
			char ans;
		...
		void printBoard()
		{
			if(turn>10)
			{
				cout<<"No empty slots left. It's a tie!";
			}
			else
			{
			switch(turn%2)
		...
		bool checkWin()
		{
			...
			else if(board[0][2]==board[1][1]==board[2][0])//diagonal, up right to bottom left
			{
					if(board[0][2]=='O')
				{
					cout<<name1<<" wins!";
			...
			else if(board[0][0]==board[1][0]==board[2][0])//vertical, left column
			{
					if(board[0][0]=='O')
				{
					cout<<name1<<" wins!";
			...
			else if(board[0][1]==board[1][1]==board[2][1])//vertical, middle column
			{
					if(board[0][1]=='O')
				{
					cout<<name1<<" wins!";
			...
			else if(board[0][2]==board[1][2]==board[2][2])//vertical, right column
			{
					if(board[0][2]=='O')
				{
					cout<<name1<<" wins!";
			...
			else if(board[0][0]==board[0][1]==board[0][2])//horizontal, first row
			{
					if(board[0][0]=='O')
				{
					cout<<name1<<" wins!";
			...
			else if(board[1][0]==board[1][1]==board[1][2])//horiontal, middle row
			{
					if(board[1][0]=='O')
				{
					cout<<name1<<" wins!";
			...
			else if(board[2][0]==board[2][1]==board[2][2])//horizontal, bottom row
			{
					if(board[2][0]=='O')
				{
					cout<<name1<<" wins!";
